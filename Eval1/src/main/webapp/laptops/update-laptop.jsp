            ...
            <div class="card card-flush">
                ...
                <div class="card-body pt-0">
                    <form id="form" method="post" >
                        <div class="mb-5">
                            <label>Nom :</label>
                            <input type="text" name="name" class="form-control" required value="<%=laptop.getName()%>">
                        </div>
                        <div class="mb-5">
                            <label>Reference :</label>
                            <input type="text" name="reference" class="form-control" required value="<%=laptop.getReference()%>">
                        </div>
                        <div class="mb-5">
                            ...
                            <select name="cpuId" class="form-select"
                                ...
                                <option value="<%= cpu.getId() %>"
                                        <% if (laptop.getCpu() != null && laptop.getCpu().getId() == cpu.getId()) { %>
                                        selected
                                        <% } %>
                        ...
                        <div class="mb-5">
                            ...
                            <select name="brandId" class="form-select"
                                ...
                                <option value="<%= brand.getId() %>"
                                        <% if (laptop.getBrand() != null && laptop.getBrand().getId() == brand.getId()) { %>
                                        selected
                                        <% } %>
                        ...
                        <div class="row">
                            <div class="col-sm-6 mb-5">
                                ...
                                <select name="ramTypeId" class="form-select"
                                    ...
                                    <option value="<%= ramType.getId() %>"
                                            <% if (laptop.getRamType() != null && laptop.getRamType().getId() == ramType.getId()) { %>
                                            selected
                                            <% } %>
                            ...
                            <div class="col-sm-6 mb-5">
                                ...
                                <input type="text" name="ramValue" class="form-control" required value="<%=laptop.getRamValue()%>">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 mb-5">
                                ...
                                <select name="screenTypeId" class="form-select"
                                    ...
                                    <option value="<%= screenType.getId() %>"
                                            <% if (laptop.getScreenType() != null && laptop.getScreenType().getId() == screenType.getId()) { %>
                                            selected
                                            <% } %>
                            ...
                            <div class="col-sm-6 mb-5">
                                ...
                                <input type="text" name="screenSize" class="form-control" required value="<%=laptop.getScreenSize()%>">
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6 mb-5">
                                ...
                                <select name="driverTypeId" class="form-select"
                                    ...
                                    <option value="<%= driveType.getId() %>"
                                            <% if (laptop.getDriverType() != null && laptop.getDriverType().getId() == driveType.getId()) { %>
                                            selected
                                            <% } %>
