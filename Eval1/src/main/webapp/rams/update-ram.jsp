...
<%
    RamType ramType = (RamType) request.getAttribute("ramType");
%>
<head>
                ...
                <div class="card-body pt-0">
                    ...
                    <script>
                        ...
                        form.addEventListener('submit', function(evnt) {
                            ...
                            send(formData, "${pageContext.request.contextPath}/rams/<%=ramType.getId()%>", "${pageContext.request.contextPath}/rams")
                        });
                    </script>
                </div>
            </div>
